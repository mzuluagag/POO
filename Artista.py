...
class Artista(Usuario):
    ...
    def GenerarDatosFicticios():
        Artista("Diego caca","Norrea","Dice","gono@gmail.com","4","The day after tomorrow",9,"Estudiante","90000")
        Artista("caca Hulk","Smash","boom'd","hulk@gmail.com","5","YOUDONTCARE",900,"Máquina de matar","90000000")
        Artista("Tyler","Durden","John caca","tydur@gmail.com","6","Solo nihilismolok",0,"Nihilista","9000000000")
